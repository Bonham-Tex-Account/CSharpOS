...
public static class OsLayout
{
    ...
    public const int DataBase = 4096;
    ...
    public const int ProcessTableOffset = DataBase + 44;  // after header + buddy fields
    ...
    public const int TotalSize = BuddyBitmapOffset + BuddyBitmapWords * 4;
